...
TSharedPtr<FJsonValue> FDwBlueprintSnapshotExporter::BuildEventGraphJson(UBlueprint* Blueprint)
{
	if (!Blueprint)
	{
		return nullptr;
...
TSharedPtr<FJsonObject> FDwBlueprintSnapshotExporter::BuildFunctionsJson(UBlueprint* Blueprint)
{
	if (!Blueprint)
	{
		return nullptr;
